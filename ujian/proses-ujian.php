...
if (isset($_POST['simpan'])){
    ...
    mysqli_query($db, "INSERT INTO tabel_ujian VALUES('$noUjian', '$tgl', '$nis', '$jurusan', '$sum', '$min', '$max', '$avg', '$hasilUjian')");

    foreach($mapel as $key => $mpl) {
        mysqli_query($db, "INSERT INTO tabel_nilai_ujian VALUES(null, '$noUjian', '$mpl', '$jurus[$key]', '$nilai[$key]')");
    }
